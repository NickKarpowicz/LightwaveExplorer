...
if(USE_CUDA AND USE_SYCL)
    ...
    target_link_libraries(LightwaveExplorer fmt::fmt-header-only -lm miniz)
...
elseif(AMDLIBRARY)
    ...
    if(BUILD_EXECUTABLE)
        ...
        target_link_libraries(${EXECUTABLE_NAME}  fmt::fmt-header-only -lm miniz)
...
elseif(USE_SYCL)
    ...
    link_fft_library(${EXECUTABLE_NAME})
    target_link_libraries(${EXECUTABLE_NAME} TBB::tbb)
    target_link_libraries(${EXECUTABLE_NAME} fmt::fmt-header-only miniz)
    target_link_libraries(${EXECUTABLE_NAME} ${CAIRO_LIBRARIES})
    linux_install_nolaunchscript()
endif()
