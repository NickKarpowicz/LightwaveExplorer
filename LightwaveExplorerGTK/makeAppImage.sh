...
mkdir -p LightwaveExplorer.AppDir/usr/shared
mkdir -p LightwaveExplorer.AppDir/usr/shared/glib-2.0
...
cp -r /usr/shared/glib-2.0 LightwaveExplorer.AppDir/usr/shared
cp LightwaveExplorerGTK LightwaveExplorer.AppDir/usr/bin/LightwaveExplorer
